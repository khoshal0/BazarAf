        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50 flex items-center justify-center p-4">
          <div className="max-w-lg w-full space-y-6">
            <Card className="p-8 text-center bg-white border-0 shadow-md">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-2 tracking-tight">Order Confirmed!</h2>
              <p className="text-gray-600 mb-6">
                Your order has been successfully placed. Our team will contact you shortly for final delivery verification.
              </p>
              
              <div className="bg-gray-50 rounded-lg p-6 mb-6 border border-gray-200">
                <div className="text-xs uppercase tracking-wider text-gray-500 font-semibold mb-2">Order Reference</div>
                ...
                <div className="space-y-3 text-left">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-teal-700">Cash on Delivery</span>
                  </div>
                </div>
              </div>

              <p className="text-sm text-gray-500 mb-6">Redirecting to order tracking...</p>
            </Card>
          </div>
        </div>
      </Layout>
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <Card className="border-0 shadow-md p-6 bg-white">
                  ...
                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="full_name" className="text-gray-700 font-semibold mb-2 block text-sm">Full Name *</Label>
                      <Input
                        id="full_name"
                    ...
                    <div>
                      <Label htmlFor="phone" className="text-gray-700 font-semibold mb-2 block text-sm">Phone Number *</Label>
                      <Input
                        id="phone"
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="province" className="text-gray-700 font-semibold mb-2 block text-sm">Province *</Label>
                        <Input
                          id="province"
                      ...
                      <div>
                        <Label htmlFor="city" className="text-gray-700 font-semibold mb-2 block text-sm">City/District *</Label>
                        <Input
                          id="city"
                          value={formData.city}
                          onChange={(e) => setFormData({ ...formData, city: e.target.value })}
                          placeholder="e.g., Karte Parwan"
                    ...
                    <div>
                      <Label htmlFor="address" className="text-gray-700 font-semibold mb-2 block text-sm">Complete Address *</Label>
                      <Textarea
                        id="address"
                        value={formData.address}
                        onChange={(e) => setFormData({ ...formData, address: e.target.value })}
                        placeholder="Street, house number, nearby landmark"
                    ...
                    <div>
                      <Label htmlFor="notes" className="text-gray-700 font-semibold mb-2 block text-sm">Delivery Notes (Optional)</Label>
                      <Textarea
                        id="notes"
                        ...
                        <div className="flex-1">
                          <Label htmlFor="cod" className="cursor-pointer">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <span className="font-semibold text-gray-900">Cash on Delivery (Recommended)</span>
                            </div>
                            <p className="text-sm text-gray-600">
                              Pay when you receive your order. Safe and secure.
                            </p>
                          </Label>
                        </div>
                      </div>
                    ...
                    <div key={item.id} className="flex gap-4 py-4 first:pt-0 last:pb-0">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-600 space-y-1">
                          ...
                          <div>Unit Price: AFN {item.price.toLocaleString()}</div>
                        </div>
